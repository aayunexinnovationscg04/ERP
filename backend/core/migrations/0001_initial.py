    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super Admin'), ('owner', 'Owner'), ('manager', 'Manager'), ('driver', 'Driver')], default='owner', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('low_fuel_litres', models.FloatField(blank=True, null=True)),
