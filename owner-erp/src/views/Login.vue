<template>
  <div class="login2">
    ...
    <section class="brandside">
      ...
      <ul class="bs-list">
        <li><Check :size="16" /> Live fleet map &amp; vehicle status</li>
        <li><Check :size="16" /> Fuel, trips &amp; route history</li>
        <li><Check :size="16" /> Overspeed, geofence &amp; tamper alerts</li>
      </ul>
    </section>
    ...
    <section class="formside">
      <div class="formcard">
        <h2>Sign in</h2>
        <p class="sub">Owner / company access to Fuel Guard X</p>
        ...
        <p class="note">No sign-up here — accounts are created by your administrator.</p>
      </div>
    </section>
  </div>
</template>
